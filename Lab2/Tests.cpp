...
void run_tests() {
	...
	vector<Test> tests{
		...
		Test(
			...
			vector<double>{ 5.5, 95.033177771091246, 34.557519189487721 },
		...
		Test(
			...
			vector<shared_ptr<Figure>>{
				...
				make_shared<Circle>(1.234), make_shared<Rectangle>(12.46, 44.7), make_shared<Trapezoid>(78, 565, 674.5, 0.8723, 0.1234)
			...
			vector<double>{ 78, 565, 674.5, 0.8723, 0.1234, 41.670470909999999, 1318.3723000000000 }
		...
		Test(
			...
			vector<shared_ptr<Figure>>{
				...
				make_shared<Circle>(4), make_shared<Rectangle>(4.5, 14), make_shared<Trapezoid>(44, 2.8, 27.3, 8.25, 10.5)
			...
			vector<double>{ 44, 2.8, 27.3, 8.25, 10.5, 186.63749999999999, 82.349999999999994 }
